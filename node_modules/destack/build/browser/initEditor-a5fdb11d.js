...
const handleEvents = (newEditor) => {
  const saveLocally = (data) => fetchJSON({ method: "post", url: "http://localhost:3000/api/builder/handle", data: { path: "default.json", data } });
...
const loadTemplate = (editor) => {
  fetchJSON({ method: "get", url: "http://localhost:3000/api/builder/handle" }).then((data) => {
    Object.keys(data).find((c) => data[c].filename === "default.json");
  });
};
