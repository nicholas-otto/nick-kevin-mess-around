...
var index = require('./index-9427fc84.js');
require('react');
...
const handleEvents = (newEditor, standaloneBuilder) => {
  const baseUrl = standaloneBuilder ? `http://localhost:${index.standaloneBuilderPort}` : "";
  const saveLocally = (data) => fetchJSON({
    method: "post",
...
const uploadFile = (e, editor, standaloneBuilder) => {
...
const initEditor = async (isDev = true, standaloneBuilder) => {
  ...
  if (isDev) {
    assetManagerOptions.uploadFile = (e) => uploadFile(e, editor, standaloneBuilder);
