...
const ContentProvider = ({
  ...
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-a38cb150.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    } else {
  ...
  if (showEditor)
    ...
    return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, /* @__PURE__ */ React__default["default"].createElement("link", {
      ...
      rel: "stylesheet",
      href: tailwindCssUrl
    }), /* @__PURE__ */ React__default["default"].createElement("style", null, prodStyles), /* @__PURE__ */ React__default["default"].createElement("style", null, " ", css), /* @__PURE__ */ React__default["default"].createElement("div", {
