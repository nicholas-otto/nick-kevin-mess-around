...
const rr = typeof window === "undefined";
const ContentProvider = ({
  ...
  console.log(rr);
  const [tailwindLoaded, setTailwindLoaded] = React.useState(typeof window === "undefined");
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-0e660ad9.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    }
  }, []);
  if (showEditor)
    return /* @__PURE__ */ React__default["default"].createElement("div", {
    ...
    return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, /* @__PURE__ */ React__default["default"].createElement("link", {
      ...
      href: tailwindCssUrl
    }), /* @__PURE__ */ React__default["default"].createElement("style", null, prodStyles), /* @__PURE__ */ React__default["default"].createElement("style", null, " ", css), tailwindLoaded && /* @__PURE__ */ React__default["default"].createElement("div", {
      dangerouslySetInnerHTML: { __html: html != null ? html : "" }
    }), /* @__PURE__ */ React__default["default"].createElement(ToastContainer, null));
};
ContentProvider.getInitialProps = async ({ req }) => {
  return { isServer: !!req };
};
