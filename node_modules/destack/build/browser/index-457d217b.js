...
const ContentProvider = ({
  ...
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-88a90ece.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    } else {
      const tailwindLink = document.createElement("style");
      tailwindLink.textContent = `@import "${tailwindCssUrl}"`;
      const timer = setInterval(() => {
        var _a, _b;
        console.log((_a = tailwindLink.sheet) == null ? void 0 : _a.cssRules);
        try {
          (_b = tailwindLink.sheet) == null ? void 0 : _b.cssRules;
