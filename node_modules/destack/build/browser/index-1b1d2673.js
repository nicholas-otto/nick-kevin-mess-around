...
const timer = setInterval(() => {
  ...
  try {
    linkRef.current.sheet.cssRules;
...
const ContentProvider = ({
  ...
  const linkRef2 = React.useRef(null);
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-a8680a2d.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    }
  }, []);
  if (showEditor)
    return /* @__PURE__ */ React__default["default"].createElement("div", {
