...
const ContentProvider = ({
  ...
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-8f98a189.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    } else {
      var linkEl = linkRef.current;
      Boolean(linkEl.sheet);
      linkEl.addEventListener("onload", function() {
  ...
  if (showEditor)
    ...
    return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, /* @__PURE__ */ React__default["default"].createElement("link", {
      ...
      href: "https://unpkg.com/tailwindcss@2.1.4/dist/tailwind.min.css"
    }), /* @__PURE__ */ React__default["default"].createElement("style", {
      ref: linkRef,
      onLoad: () => console.log(true)
    }, `@import "${tailwindCssUrl}"`), /* @__PURE__ */ React__default["default"].createElement("style", null, prodStyles), /* @__PURE__ */ React__default["default"].createElement("style", null, " ", css), tailwindLoaded && /* @__PURE__ */ React__default["default"].createElement("div", {
