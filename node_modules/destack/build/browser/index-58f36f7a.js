...
const ContentProvider = ({
  ...
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-c9a1a727.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    }
  }, []);
  if (showEditor)
    return /* @__PURE__ */ React__default["default"].createElement("div", {
    ...
    return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, /* @__PURE__ */ React__default["default"].createElement("link", {
      ...
      href: tailwindCssUrl
    }), /* @__PURE__ */ React__default["default"].createElement("style", null, prodStyles), /* @__PURE__ */ React__default["default"].createElement("style", null, " ", css), tailwindLoaded && !ssr && /* @__PURE__ */ React__default["default"].createElement("div", {
