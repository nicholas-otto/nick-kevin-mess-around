...
const ContentProvider = ({
  ...
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-87d3895a.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    } else {
      const timer = setInterval(() => {
        var _a;
        try {
          (_a = linkRef.current.sheet) == null ? void 0 : _a.cssRules;
