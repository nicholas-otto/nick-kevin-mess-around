...
const ContentProvider = ({
  ...
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-43147c2d.js'); }).then((c) => c.initEditor(isDev, standaloneServer));
    } else {
...
const ContentProviderReact = () => {
  ...
  React.useEffect(() => {
    const pathName = window.location.pathname === "/" || window.location.pathname === "" ? "default.json" : `${window.location.pathname.substring(1)}.json`;
    if (!isDev) {
