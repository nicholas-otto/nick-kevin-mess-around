...
const ContentProvider = ({
  ...
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-829f3665.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    } else {
      const tailwindLink = document.createElement("style");
      tailwindLink.textContent = `@import "${tailwindCssUrl}"`;
      const timer = setInterval(() => {
        console.log(tailwindLink.sheet.cssRules);
        try {
          tailwindLink.sheet.cssRules;
          console.log("tailwind loaded");
          clearInterval(timer);
        } catch (e) {
        }
      }, 1);
      document.head[0].appendChild(tailwindLink);
    }
  }, []);
  if (showEditor)
    return /* @__PURE__ */ React__default["default"].createElement("div", {
    ...
    return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, /* @__PURE__ */ React__default["default"].createElement("style", null, prodStyles), /* @__PURE__ */ React__default["default"].createElement("style", null, " ", css), /* @__PURE__ */ React__default["default"].createElement("div", {
...
const ContentProviderReact = () => {
  ...
  const [data, setData] = React.useState({ html: void 0, css: void 0 });
  React.useEffect(() => {
    if (!isDev || true) {
      fetch("/data/default.json").then((response) => response.json()).then((_data) => {
        setData(_data);
        setLoaded(true);
      });
    } else {
      setData({ html: void 0, css: void 0 });
      setLoaded(true);
    }
  }, []);
  return /* @__PURE__ */ React__default["default"].createElement("div", {
...
exports.standaloneBuilderPort = standaloneBuilderPort;
