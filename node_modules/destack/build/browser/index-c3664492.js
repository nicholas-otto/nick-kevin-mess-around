...
const ContentProvider = ({
  ...
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-4d7095aa.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    }
    ...
    const fi = setInterval(function() {
      try {
        ...
        console.log("listening to @import-ed cssRules");
        clearInterval(fi);
      } catch (e) {
      }
    }, 10);
