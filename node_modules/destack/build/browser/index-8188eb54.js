...
const ContentProvider = ({
  ...
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-c6e157ef.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    } else {
      const tailwindLink = linkRef.current;
      const timer = setInterval(() => {
        var _a;
        console.log(tailwindLink);
        try {
          (_a = tailwindLink.sheet) == null ? void 0 : _a.cssRules;
  ...
  if (showEditor)
    ...
    return /* @__PURE__ */ React__default["default"].createElement(React__default["default"].Fragment, null, /* @__PURE__ */ React__default["default"].createElement("style", null, `@import "${tailwindCssUrl}"`), /* @__PURE__ */ React__default["default"].createElement("style", null, prodStyles), /* @__PURE__ */ React__default["default"].createElement("style", null, " ", css), /* @__PURE__ */ React__default["default"].createElement("div", {
