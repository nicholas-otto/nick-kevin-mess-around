...
const ContentProvider = ({
  ...
  React.useEffect(() => {
    if (showEditor) {
      Promise.resolve().then(function () { return require('./initEditor-53c23d22.js'); }).then((c) => c.initEditor(isDev, standaloneBuilder));
    } else {
      const style = document.createElement("style");
      style.textContent = `@import "${tailwindCssUrl}"`;
