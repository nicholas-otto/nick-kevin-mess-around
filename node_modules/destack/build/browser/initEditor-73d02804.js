...
var index = require('./index-806bb5a8.js');
require('react');
...
const initEditor = async (showEditor = true, startServer = true, standaloneServer) => {
...
const loadTemplate = (editor, standaloneServer) => {
  const pathName = window.location.pathname === "/" ? "/default.json" : `${window.location.pathname}.json`;
  const baseUrl = standaloneServer ? `http://localhost:${index.standaloneServerPort}` : "";
  console.log("loadTemplate");
  index.fetchJSON({ method: "get", url: `${baseUrl}/api/builder/handle` }).then((data) => {
