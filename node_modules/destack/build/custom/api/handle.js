...
var uploadFiles = function (req) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 4:
                files = _a.sent();
                urls = Object.values(files).map(function (f) { var _a; return path_1["default"].join('/', uploadPath, (_a = f.name) !== null && _a !== void 0 ? _a : ''); });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                folderPathExists = body.path.split('/').slice(0, -1).join('/');
