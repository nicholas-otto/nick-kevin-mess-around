...
__export(exports, {
  DbExecuteNeedsPreviewFeatureFlagError: () => DbExecuteNeedsPreviewFeatureFlagError,
  ...
  MigrateDiffNeedsPreviewFeatureFlagError: () => MigrateDiffNeedsPreviewFeatureFlagError,
...
class DbExecuteNeedsPreviewFeatureFlagError extends Error {
  constructor() {
    super(`This command is in Preview. Use the --preview-feature flag to use it like ${import_chalk.default.bold.greenBright((0, import_sdk.getCommandWithExecutor)(`prisma db execute --preview-feature`))}`);
  }
}
__name(DbExecuteNeedsPreviewFeatureFlagError, "DbExecuteNeedsPreviewFeatureFlagError");
__name2(DbExecuteNeedsPreviewFeatureFlagError, "DbExecuteNeedsPreviewFeatureFlagError");
class MigrateDiffNeedsPreviewFeatureFlagError extends Error {
  constructor() {
    super(`This command is in Preview. Use the --preview-feature flag to use it like ${import_chalk.default.bold.greenBright((0, import_sdk.getCommandWithExecutor)(`prisma migrate diff --preview-feature`))}`);
  }
}
__name(MigrateDiffNeedsPreviewFeatureFlagError, "MigrateDiffNeedsPreviewFeatureFlagError");
__name2(MigrateDiffNeedsPreviewFeatureFlagError, "MigrateDiffNeedsPreviewFeatureFlagError");
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
  DbExecuteNeedsPreviewFeatureFlagError,
  DbNeedsForceError,
  DbPushForceFlagRenamedError,
  DbPushIgnoreWarningsWithFlagError,
  HowToBaselineError,
  MigrateDevEnvNonInteractiveError,
  MigrateDiffNeedsPreviewFeatureFlagError,
