...
var initConfig = require('../../dist/initConfig-641adecb.cjs.prod.js');
var migrations = require('../../dist/migrations-e391f8de.cjs.prod.js');
var requireSource = require('../../dist/requireSource-07dc5fc7.cjs.prod.js');
var createAdminUIMiddleware = require('../../dist/createAdminUIMiddleware-872b84e1.cjs.prod.js');
var artifacts_dist_keystone6CoreArtifacts = require('../../dist/artifacts-fadd86da.cjs.prod.js');
var utils = require('../../dist/utils-f651a2f8.cjs.prod.js');
var typesForLists = require('../../dist/types-for-lists-51d061d4.cjs.prod.js');
...
require('../../dist/graphql-errors-36f8a6f9.cjs.prod.js');
...
require('image-type');
require('image-size');
require('../../fields/types/image/utils/dist/keystone-6-core-fields-types-image-utils.cjs.prod.js');
require('crypto');
require('stream');
require('filenamify');
require('@sindresorhus/slugify');
require('../../fields/types/file/utils/dist/keystone-6-core-fields-types-file-utils.cjs.prod.js');
require('node-fetch');
require('form-data');
require('cuid');
...
require('@hapi/iron');
require('uid-safe');
require('../../dist/createApolloServer-2b6d7bed.cjs.prod.js');
...
async function setupInitialKeystone(config, cwd, shouldDropDatabase) {
  ...
  if (config.db.useMigrations) {
    migrationPromise = migrations.devMigrations(config.db.url, prismaSchema, artifacts_dist_keystone6CoreArtifacts.getSchemaPaths(cwd).prisma, shouldDropDatabase);
  } else {
    migrationPromise = migrations.pushPrismaSchemaToDatabase(config.db.url, prismaSchema, artifacts_dist_keystone6CoreArtifacts.getSchemaPaths(cwd).prisma, shouldDropDatabase);
  }
