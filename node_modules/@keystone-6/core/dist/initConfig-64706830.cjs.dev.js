...
var adminMetaGraphql = require('./admin-meta-graphql-646e7d45.cjs.dev.js');
...
var typesForLists = require('./types-for-lists-aa4823f2.cjs.dev.js');
...
var fields_types_image_utils_dist_keystone6CoreFieldsTypesImageUtils = require('../fields/types/image/utils/dist/keystone-6-core-fields-types-image-utils.cjs.dev.js');
var crypto = require('crypto');
var stream = require('stream');
var filenamify = require('filenamify');
var slugify = require('@sindresorhus/slugify');
var fields_types_file_utils_dist_keystone6CoreFieldsTypesFileUtils = require('../fields/types/file/utils/dist/keystone-6-core-fields-types-file-utils.cjs.dev.js');
...
function createImagesContext(config, cloudAssets) {
  ...
  return {
    ...
    getDataFromRef: async ref => {
      const imageRef = fields_types_image_utils_dist_keystone6CoreFieldsTypesImageUtils.parseImageRef(ref);
...
function createFilesContext(config, cloudAssets) {
  ...
  return {
    ...
    getDataFromRef: async ref => {
      const fileRef = fields_types_file_utils_dist_keystone6CoreFieldsTypesFileUtils.parseFileRef(ref);
