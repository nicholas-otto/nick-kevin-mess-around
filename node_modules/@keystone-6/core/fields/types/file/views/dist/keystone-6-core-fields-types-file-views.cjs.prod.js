...
var fields_types_file_utils_dist_keystone6CoreFieldsTypesFileUtils = require('../../utils/dist/keystone-6-core-fields-types-file-utils.cjs.prod.js');
...
function validateRef(_ref) {
  ...
  if (!fields_types_file_utils_dist_keystone6CoreFieldsTypesFileUtils.parseFileRef(ref)) {
    return 'Invalid ref';
  }
}
