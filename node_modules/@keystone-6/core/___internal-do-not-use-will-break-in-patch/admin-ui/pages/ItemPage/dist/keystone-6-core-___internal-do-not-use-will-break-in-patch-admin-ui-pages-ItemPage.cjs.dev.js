...
var PageContainer = require('../../../../../dist/PageContainer-0074a451.cjs.dev.js');
var GraphQLErrorNotice = require('../../../../../dist/GraphQLErrorNotice-b8e9740e.cjs.dev.js');
...
const ItemPage = _ref4 => {
  ...
  return core.jsx(PageContainer.PageContainer, {
    ...
    tone: "negative"
  }, metaQueryErrors[0].message)) : core.jsx(ColumnLayout, null, (data === null || data === void 0 ? void 0 : data.item) == null ? core.jsx(core.Box, {
    marginY: "xlarge"
